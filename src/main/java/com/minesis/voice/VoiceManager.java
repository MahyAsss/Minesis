 ...
 */
@Mod.EventBusSubscriber(modid = "minesis", bus = Mod.EventBusSubscriber.Bus.FORGE, value = Dist.CLIENT)
public class VoiceManager {
    private static volatile boolean voiceChatAvailable = false;
    private static final Map<UUID, VoiceCaptureHandler> activeCaptureHandlers = new java.util.concurrent.ConcurrentHashMap<>();
